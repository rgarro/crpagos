<div id="ClientForm" >
	<ul style="float:none">
		<li><a href="#Bus"><?php __('Company') ?></a></li>
		<li><a href="#Per"><?php __('Personal') ?></a></li>
	</ul>
	<div id="Bus" style="padding:0px">
			...
			<table border="0" class="zebra" align="center" width="500">
				<tr>
					<td width="200" valign="top" nowrap=""><label for="ClientName">*<?php __('CompanyName') ?>:</label></td>
					<td width="300"><input type="text" name="ClientName" tabindex="8" size="30" maxlength="200" value=""></td>
				</tr>
				<tr>
					<td><label for="Email" valign="top">*<?php  __('Email') ?>:</label></td>
				...
				<tr>
					<th colspan="2" align="center">
						<input type="submit" value="<?php __('SaveCompany') ?>" name="QuickSubmitB" id="QuickSubmitB" tabindex="13">&nbsp;
						<input type="button" name="CloseB" id="CloseB" value="<?php __('Close')?>">
					</th>
				</tr>
			</table>
		</form>
	...
	<div id="Per"  style="padding:0px">
			...
			<table border="0" class="zebra" align="center" width="500">
				<tr>
					<td width="200" valign="top"><label for="ClientName">*<?php __('ClientName') ?></label></td>
					<td width="300"><input type="text" name="ClientName" tabindex="8" size="30" maxlength="30" value=""></td>
				</tr>
					<tr>
					<td valign="top"><label for="ClientLastName">*<?php __('ClientLastName') ?></label></td>
				...
				<tr>
					<th colspan="2" align="center">
						...
						<input type="button" name="CloseP" id="CloseP" value="<?php __('Close')?>">
					</th>
				</tr>
			</table>
		</form>
