...
<fieldset style="width: 400px; margin: 10px auto;">
	<ol style="list-style: none">
		<input type="hidden" id="InvalidCCCard" value="<?php echo __('InvalidCCCard')?>" />
		<li>
			<label for="CCHolder" style="display: block;margin: 0px;float: left;width: 150px;">*<?php echo __('CardHolderName') ?>:</label>
			<input type="text" name="CCHolder" id="CCHolder" value="<?php echo $session->read('CardData.CCHolder') ?>" maxlength="50"/>
		</li>
		<li>
			<label for="CCNumber" style="display: block;margin: 0px;float: left;width: 150px;">*<?php echo __('CCNumber') ?>:</label>
		...
		<li>
			<label for="CVV" style="display: block;margin: 0px;float: left;width: 150px;">*<?php echo __('CVV') ?>:</label>
		...
		<li>
		<li>
			<label for="ccexp" style="display: block;margin: 0px;float: left;width: 150px;">*<?php echo __('ExpireDate') ?>:</label>
