...
$.fn.addToList = function(options) {
	...
	return this.each(function() {
		...
		// custom action for validation		
			me.bind('TheClientForm-submit', function(){
		// submit the the form, ajax style
				$("#TheClientForm").ajaxSubmit({
					success: processAjax,
		...
		// custom action for validation		
			me.bind('TheBusForm-submit', function(){
		// submit the the form, ajax style
				$("#TheBusForm").ajaxSubmit({
					success: processAjax,
					dataType: options.dataType
			});
			// cancel the default form submit action
